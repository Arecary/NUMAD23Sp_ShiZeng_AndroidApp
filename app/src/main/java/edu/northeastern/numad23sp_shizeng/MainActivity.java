...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Button button5 = (Button) findViewById(R.id.btn_WebService);
    Button button6 = (Button) findViewById(R.id.btn_FireBase);
    Button button7 = (Button) findViewById(R.id.btn_location);
    Button button8 = (Button) findViewById(R.id.btn_Fragment);
/*        button1.setOnClickListener(new View.OnClickListener() {
  ...
  public void onClick(View view) {
    ...
    if (view.getId() == R.id.button_AboutMe) {
      ...
      i.setClass(this, Fragment.class);
      startActivity(i);
    }
  }
